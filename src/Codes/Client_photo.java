 ...
 * @author Manish
 */
public class Client_photo extends javax.swing.JFrame {
  ...
  public boolean verify()
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Upload Photo Using WebCam");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     //jTextField2.setText(filename2);
        ...
        if(result == JFileChooser.APPROVE_OPTION)
        {
            ...
            java.awt.Image newImage = img.getScaledInstance(jLabel5.getWidth(), jLabel5.getHeight(), java.awt.Image.SCALE_SMOOTH );
        ...
        try{
            ...
            String query ="INSERT into c_photo values(?,?,?)";
 ...
 static
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Client_photo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Client_photo().setVisible(true);
            }
        });
    }
